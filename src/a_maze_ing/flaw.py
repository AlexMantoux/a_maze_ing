...
def _wall_breakable_toward(grid: list[list[Cell]], cell: Cell, direction: CardinalPoint) -> bool:
...
def _remove_walls_toward(grid: list[list[Cell]], cell: Cell, direction: CardinalPoint) -> None:
	"""
